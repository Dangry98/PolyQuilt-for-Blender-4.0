...
class PolyQuiltPreferences(AddonPreferences):
    ...
    pq_double_threshold : FloatProperty(
        name="Double Threshold",
        description="Distance threshold used for merging/ snapping doubles",
        default=0.0001,
        min=0.0,
        max=1.0)

    pq_double_threshold_switch : BoolProperty(
        name="Use Custom Double Threshold",
        description="When enabled, use the custom pq_double_threshold value",
        default=False
    )
